...
const SchoolCard = ({ school }: { school: University }) => {
    return (
        <div>
            {
                school && (
                    <div className="mb-[10px] p-[15px] bg-white border border-gray-300 shadow-inner rounded-2xl mt-[20px]">
                        <div className=" flex justify-between gap-0 md:gap-[30px] flex-col md:flex-row">
                            ...
                            <div className="flex flex-1 flex-col border-none lg:border-r lg:border-[1px solid] lg:border-gray-300 items-center lg:items-start">
                                ...
                                <div className="flex flex-wrap w-[100%] lg:justify-start justify-center">
