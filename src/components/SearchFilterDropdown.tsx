...
const SearchFilterDropdown = ({value, onChange}: Props) => {
    return (
        ...
        <select value={value}  onChange={onChange} className="row text-[1rem] px-10 py-2 cursor-pointer text-gray-500 bg-white border border-gray-400 rounded-2xl shadow-sm outline-none appearance-none focus:border-black">
