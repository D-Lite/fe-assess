...
const SearchFilterDropdown = () => {
    return (
        <select className="row text-[1rem] px-8 py-2 cursor-pointer text-gray-500 bg-white border border-gray-400 rounded-2xl shadow-sm outline-none appearance-none focus:border-black">
